package com.ntth.socialnetwork.security.services;
...
import com.ntth.socialnetwork.repository.RefreshTokenRepository;
import com.ntth.socialnetwork.repository.UserRepository;

@Service
public class RefreshTokenService {
	@Value("${socialnetwork.app.jwtRefreshExpirationMs}")
